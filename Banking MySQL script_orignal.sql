...
create table account
   (account_numeric 	varchar(15)	not null unique,
    branch_name		varchar(15)	not null,
    balance 		numeric		not null,
    primary key(account_numeric),
...
create table depositor
   (customer_name 	varchar(15)	not null,
    account_numeric 	varchar(15)	not null,
    primary key(customer_name, account_numeric),
    foreign key(account_numeric) references account(account_numeric),
